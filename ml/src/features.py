...
# features.py
NUMERIC_FEATURES = ["Customer_Age", "Purchase_Amount", "Footfall_Count"]
CATEGORICAL_FEATURES = ["Customer_Loyalty_Tier","Location","Product_Category","Payment_Method","Device_Type"]
DATE_TIME = ["Transaction_Date","Transaction_Time"]
ID_OR_DROP = ["Transaction_ID","Customer_ID","Store_ID","Product_SKU","IP_Address","Fraud_Flag"]
FEATURE_COLS = NUMERIC_FEATURES + CATEGORICAL_FEATURES + DATE_TIME
